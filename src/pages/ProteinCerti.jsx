...
export default function ProteinCerti() {
  return (
    <>
      <Navbar />
      <section className="lab-hero" style={{backgroundImage:"url(https://m.media-amazon.com/images/S/aplus-media-library-service-media/cae63ca0-3469-411f-b299-62c245625702.__CR0,0,970,300_PT0_SX970_V1___.jpg)",padding:'0px'}}> 
    <div className="overlay"></div>
    <div className="hero-content" >
        {/* <img src="https://m.media-amazon.com/images/S/aplus-media-library-service-media/cae63ca0-3469-411f-b299-62c245625702.__CR0,0,970,300_PT0_SX970_V1___.jpg" className="hero-icon" /> */}
