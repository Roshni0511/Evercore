        ...
        <div className="container-fluid-lg">
            <div className="row">
                <div className="col-12">
                    ...
                    <div
                        className="row g-sm-4 g-3 row-cols-xxl-6 row-cols-xl-3 row-cols-lg-2 row-cols-md-3 row-cols-2 product-list-section">
                        <div>
                            ...
                            <div className="product-box-3 h-100 wow fadeInUp" data-wow-daley="0.05s">
                                ...
                                <div className="product-footer">
                                    <div className="product-detail">
                                        {/* <span className="span-name">Vegetable</span> */}
                                        <a href="/Productdetails">
                                            <h5 className="name">Evercore Yeast Protein - Vanilla Essential
</h5>
                                        </a>
